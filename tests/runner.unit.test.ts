...
const SORT_CONFIG_STARS_DESC = { sort_by: "stars" as const, sort_order: "desc" as const };
const SORT_CONFIG_STARS_ASC = { sort_by: "stars" as const, sort_order: "asc" as const };
const SORT_CONFIG_NAME_ASC = { sort_by: "name" as const, sort_order: "asc" as const };
const SORT_CONFIG_UPDATED_DESC = { sort_by: "updated_at" as const, sort_order: "desc" as const };

const SELECT_CONFIG_UNLIMITED = { max_repos_per_run: 0 };
const SELECT_CONFIG_LIMIT_TWO = { max_repos_per_run: 2 };
