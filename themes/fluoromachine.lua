-- themes/fluoromachine.lua - Custom loader for fluoromachine.nvim
...
return function(entry, vim_opts)
  ...
  local ok, mod = pcall(require, "fluoromachine")
  if ok and mod.setup then
    mod.setup({})
  end
  vim.cmd.colorscheme(entry.colorscheme or "fluoromachine")
end
